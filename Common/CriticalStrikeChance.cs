...
namespace SummoningExpanded.Common.GlobalProjectiles {
    public class CriticalStrikeChance : GlobalProjectile {
        public override bool AppliesToEntity(Projectile entity, bool lateInstantiation) => entity.CountsAsClass(DamageClass.Summon);
...
namespace SummoningExpanded.Common.GlobalItems {
    public class CriticalStrikeChance : GlobalItem {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation) => entity.CountsAsClass(DamageClass.Summon);
